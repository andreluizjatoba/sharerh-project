...
insert into tb_account(id, name_owner, agency_code, number_account, digit_verification, register_id)
  values (1, 'Pedro Luiz Lacativa', '0011', '00000123', '001', '123.456.789-01');

insert into tb_account(id, name_owner, agency_code, number_account, digit_verification, register_id)
  values (2, 'João Luiz Pavaneli', '0022', '00000456', '002', '123.456.789-02');
 
insert into tb_account(id, name_owner, agency_code, number_account, digit_verification, register_id)
  values (3, 'André Jatobá', '0011', '00000789', '003', '123.456.789-03');
